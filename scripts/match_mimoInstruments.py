...
## Matches CH instrument IDs to Wikidata and MIMO IDs using existing
## MusicBrainz ID alignment
...
with open(filePath_1, encoding='utf-8', errors='ignore') as f1:
...
with open(filePath_2, encoding='utf-8', errors='ignore') as f2:
...
print(len(ch_toMIMO_Dict), "instruments matched")
